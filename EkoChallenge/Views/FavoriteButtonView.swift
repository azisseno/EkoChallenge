...
import UIKit
class FavoriteButtonView: UIButton {
    ...
    @objc func touchDown(_ sender: FavoriteButtonView) {
        self.layer.opacity = 0.4
    }
    @objc func touchUpInside(_ sender: FavoriteButtonView) {
        self.layer.opacity = 1.0
    }
    @objc func touchDragExit(_ sender: FavoriteButtonView) {
        self.layer.opacity = 1.0
    }
    @objc func touchDragEnter(_ sender: FavoriteButtonView) {
        self.layer.opacity = 0.4
    }
    @objc func touchCancel(_ sender: FavoriteButtonView) {
        self.layer.opacity = 1.0
    }
